...
# ----------------------------------------------------------------------
# ----------------------------------------------------------------------
# add resolvents and baseline but predicted reward not implemeted yet
# ----------------------------------------------------------------------
# ----------------------------------------------------------------------
# ----------------------------------------------------------------------
...
POLICIES = ["random", "greedy", "unique", "pickup_deadline", "pickup_deadline_distance", "predicted_reward", "predicted_reward_joint"]
